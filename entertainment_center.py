...
movies = [
    media.Movie(
        ...
        "https://upload.wikimedia.org/wikipedia/en/9/9b/"
        "Ferris_Bueller%27s_Day_Off.jpg",
    ...
    media.Movie(
        ...
        "Original_Rocky_Horror_Picture_Show_poster.jpg",
    ...
    media.Movie(
        ...
        "of diner bandits intertwine in four tales of violence and "
        "redemption.",
